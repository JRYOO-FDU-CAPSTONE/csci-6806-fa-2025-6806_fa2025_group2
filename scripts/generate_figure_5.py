...
def generate_figure_5_tau_dt(results):
    ...
    ax1.set_title('Peak DT vs. τ_DT (E1 DT-SLRU)', fontweight='bold', pad=15, fontsize=16)
    ...
    ax2.set_title('Hit Rate vs. τ_DT (E1 DT-SLRU)', fontweight='bold', pad=15, fontsize=16)
