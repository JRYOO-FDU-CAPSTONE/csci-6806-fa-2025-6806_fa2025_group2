...
def extract_protected_cap_metrics():
    ...
    # Get project root (3 levels up from script directory)
    script_dir = Path(__file__).parent
    project_root = script_dir.parent.parent.parent
    results_file = project_root / 'assignment4' / 'results' / 'fig_6_protected_cap_results.json'
...
def generate_figure_6_protected_cap(results):
    ...
    ax1.set_title('Peak DT vs. PROTECTED cap (E2 EDE)', fontweight='bold', pad=15, fontsize=16)
    ...
    plt.suptitle('Peak DT vs. PROTECTED Cap (E2 EDE Ablation Study)', 
