...
def extract_alpha_tti_metrics():
    ...
    results_file = project_root / 'assignment4' / 'results' / 'fig_7_alpha_tti_results.json'
...
def generate_figure_7_alpha_tti(results):
    ...
    ax1.set_title('Peak DT vs. α_tti (E2 EDE)', fontweight='bold', pad=15, fontsize=16)
    ...
    plt.suptitle('Peak DT vs. alpha_tti (E2 EDE Ablation Study)', 
